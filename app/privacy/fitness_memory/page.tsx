...
export default function FitnessMemoryPrivacyPage() {
	return (
				...
				<div className="space-y-8">
					<section className="space-y-4">
						...
						<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
							...
							<br />
							トレーニングの記録は、すべてあなたの端末内にのみ保存され、外部に送信されることはありません。
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
							あなたが入力したトレーニングの記録（種目、重量、レップ数、セット数など）は、すべてあなたの端末内にのみ保存されます。
							<br />
							これらのデータは、Apple社のSwiftDataフレームワークを使用して安全に保存されており、他のアプリからアクセスされることはありません。
							<br />
							iCloudバックアップを有効にしている場合、端末のバックアップデータに含まれる可能性がありますが、これはApple社のプライバシーポリシーに従って管理されます。
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
							このアプリによる情報収集を止めたい場合、またはあなたのトレーニング記録を完全に削除したい場合は、アプリを削除してください。
							<br />
							スマートフォンの設定画面から、通常の方法でアプリを削除できます。
							<br />
							アプリを削除すると、保存されていたすべてのトレーニング記録も削除されます。
						</div>
					</section>
					...
					<section className="space-y-4">
						...
						<div className="text-gray-600 dark:text-gray-400 leading-relaxed">
							...
							<br />
							トレーニング記録は、すべてあなたの端末内に安全に保存されています。
						</div>
					</section>
			...
			<div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-none border border-gray-200 dark:border-gray-800">
				...
				<div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
					...
					<p className="text-xs mt-4 border-t pt-3">
						このプライバシーポリシーは 2025年12月3日 から有効です。
					</p>
				</div>
			</div>
		</article>
