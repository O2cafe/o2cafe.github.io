							...
							>
								<div className="space-y-2">
									...
									<p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl">
										We design and develop web applications
										that make an impact. Clean, functional,
										and visually striking that AI said.
									</p>
								</div>
						...
						>
							<div className="space-y-2">
								...
								<p className="max-w-[700px] text-gray-500 dark:text-gray-400 md:text-xl">
									A showcase of our most impactful work across
						...
						<div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
							...
							>
								<div className="space-y-2">
									...
									<p className="max-w-[600px] text-gray-500 dark:text-gray-400 md:text-xl">
										We believe in minimalism, functionality,
										and purpose-driven design.
									</p>
								</div>
								<div className="space-y-4 text-gray-500 dark:text-gray-400">
									<p>
										Founded in 2025, 02Cafe is a komeda
										coffee lover's clann. We call ourself a
										web developer, but in reality, we just
										pray to the AI in our VS Code and hopes
										for miracles.
									</p>
									<p>
										We approach each project the way AI told
										us to — with meticulous attention to
										detail, clean code, intuitive UX, and
										designs that speak for themselves.
										Whether it’s a scrappy startup or a
										legacy enterprise, we just follow the
										AI’s advice and somehow end up with
										beautiful results.
									</p>
								</div>
							</motion.div>
									...
									<div className="flex flex-col gap-4">
										...
										>
											...
											<p className="text-sm text-gray-500 dark:text-gray-400">
												We begin with thorough research
												to understand your goals and
												audience by using AI.
											</p>
										</motion.div>
									</div>
									<div className="flex flex-col gap-4">
										...
										>
											...
											<p className="text-sm text-gray-500 dark:text-gray-400">
												We create clean, functional
												designs that align with your
